...
class Config(BaseSettings):
    ...
    DATABASE_DEFAULT_DB_HOSTNAME: str
    DATABASE_DEFAULT_DB_PORT: int
    DATABASE_DEFAULT_DB_USERNAME: str
    DATABASE_DEFAULT_DB_PASSWORD: str
    DATABASE_DEFAULT_DB_NAME: str
