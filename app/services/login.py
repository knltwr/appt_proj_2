...
async def service_login(login_req: OAuth2PasswordRequestForm, db: Database) -> schemas_oauth2.Token: # login_req: auth.LoginRequest ... OAuth2PasswordRequestForm looks for Form Data in request
