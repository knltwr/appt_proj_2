...
async def login(login_req: OAuth2PasswordRequestForm = Depends(), db: Database = Depends(get_db)): # login_req: auth.LoginRequest ... OAuth2PasswordRequestForm looks for Form Data in request
